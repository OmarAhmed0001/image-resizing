...
var valide = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var name_1, width, hieght;
    return __generator(this, function (_a) {
        try {
            name_1 = req.params.name;
            width = req.params.width;
            hieght = req.params.hieght;
            if (!fs_1.default.existsSync("images/".concat(name_1)) || !name_1) {
